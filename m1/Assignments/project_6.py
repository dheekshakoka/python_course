...
book_due  = input("Do you have to return any books? (yes / no): ").strip().lower()
...
if day in ("Saturday", "Sunday"):
    print("Day type    : Weekend. a good time for a long library visit!")
elif day == "Monday":
    print("Day type    : First day of the week. Check your book list.")
elif day == "Friday":
    ...
    print("Day type    : Day not recognised. Please check your answer.")

# Topic 2 -- AND operator: sunny AND book due
if weather == "sunny" and book_due == "yes":
    print("Library tip : Very good weather😀 Return your book and borrow a new one.")

# Topic 3 -- OR operator: rainy OR cloudy
if weather == "rainy" or weather == "cloudy":
    print("Carry an umbrella if you are going to the library.")

# Topic 4 -- NOT operator: book NOT due
if not (book_due == "yes"):
    print("No book return needed today. You can get new books.")

# Topic 5 -- Combining AND + OR + NOT together
if weather == "rainy" and book_due == "yes":
    print("Visit the library carefully and return your book on time.")
    ...
    print("Perfect day for a long time at the library!")
else:
    print("Plan a simple library visit.")

print()
print("Library plan complete📚😊🎒")
